...
## Overview
This guide shows how to properly integrate the Sign Language ASL Recognition Backend (running at `http://192.168.1.66:5000`) with your React Native frontend.
...
- **Port**: `5000`
- **Backend URL**: `http://192.168.1.66:5000`
- **Frontend URL**: `http://192.168.1.66:19006`
...
const BASE_URL = Platform.select({
  ios: 'http://192.168.1.66:5000',
  android: 'http://192.168.1.66:5000', // Android emulator
  web: 'http://192.168.1.66:5000'
});
...
```
API_BASE_URL=http://192.168.1.66:5000
```
...
const BASE_URL = Platform.select({
  ios: process.env.API_BASE_URL || 'http://192.168.1.66:5000',
  android: process.env.API_BASE_URL || 'http://192.168.1.66:5000',
  web: process.env.API_BASE_URL || 'http://192.168.1.66:5000'
});
...
1. **Network Connection Error**
   ...
   - Check that `192.168.1.66` is accessible from your device
   - Verify firewall settings allow traffic on port 5000

2. **CORS Errors**
   - Backend is pre-configured for `http://192.168.1.66:19006`
...
- [ ] Backend configured for IP `192.168.1.66:5000`
- [ ] Frontend API URL updated to `http://192.168.1.66:5000`
...
The backend is now fully configured and ready for seamless integration with your React Native frontend using the IP address `http://192.168.1.66:5000`. 🎉